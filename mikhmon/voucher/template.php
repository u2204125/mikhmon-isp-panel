...
<?php if ($usermode == "vc") { ?>
        <tr>
          <td font-size: 12px;>Card Number</td>
        </tr>
        <tr>
...
<!-- /  -->
    <tr>
      <!-- Price  -->
      <td colspan="2" style="border-top: 1px solid black;font-weight:bold; font-size:12px">Unlimited Data <?= $timelimit; ?> <?= $datalimit; ?> <?= $price; ?></td>
<!-- /  -->
    </tr>
    <tr>
      <!-- Note  -->
      <td colspan="2" style="font-weight:bold; font-size:10px">Powered by sbnbd.net</td>
<!-- /  -->
    </tr>
<!-- /  -->
  </tbody>
